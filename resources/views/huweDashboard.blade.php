...
<div class="row" style="width: 100%; padding: 0px; margin: 0px;">
	...
	<div class="col-md-3" style="padding: 0px;">
		...
		<div class="just-center twoData">
			...
			<img src="{{asset('/images/FC_Loader.gif')}}" width="40%">
		...
		<div class="borderb " rel="huweChart" style="display: flex;width: 100%;justify-content: center; border-bottom:5px solid #075c8a" data-aos="zoom-in-right">
			...
			<div style="padding: 10px;">
				...
				<div class="d-body">{{number_format($total_bhcpf_enrollees)}}</div>
	...
	<div class="col-md-3" style="padding: 0px;">
		...
		<div class="borderb chartBtn" rel="capChart" style=" display: flex; width: 100%;justify-content:center; border-bottom:5px solid #db3b99" data-aos="zoom-in-left">
			...
			<div style="padding: 10px;">
				...
				<div class="d-body">&#8358;{{ number_format($months[intval(date('m'))]['bhcpf_cap'] )}}</div>
	...
	<div class="col-md-3" style="padding: 0px;">
		...
		<div class="borderb" rel="proChart" style=" display: flex; width: 100%;justify-content: center;border-bottom:5px solid #0aad72" data-aos="zoom-in-left">
			...
			<div style="padding: 10px;">
				...
				<div class="d-body">&#8358;{{number_format($total_bhcpf_enrollees * 570)}}</div>
...
<div class="row" style="padding: 10px; margin:0px 10px auto auto">
	...
	<div class="col-md-4" style="color: #075c8a; font-weight:bold">
			...
			<div class="just-center twoData mt-3">
				...
				<img src="{{asset('/images/point_Loader.gif')}}" width="20%">
			...
			<div style="width: 100%; height: 30px;" class="  d-flex pad ld-zoom-in" data-aos="fade-left">
				...
				<div class=" mt-2 text-size-1">{{$data['encounter_arr']['bhcpf_encounter_today']}}</div>
		...
		<div class="bg-white border ">
			...
			<div style="width: 100%; height: 30px;" class="  d-flex pad ld-zoom-in" data-aos="fade-left">
				...
				<div class=" mt-2 text-size-1">{{$data['encounter_arr']['bhcpf_encounter_this_month']}}</div>
		...
		<div class="bg-white border ">
			...
			<div style="width: 100%; height: 30px;" class="  d-flex pad ld-zoom-in" data-aos="fade-left">
				...
				<div class=" mt-2 text-size-1">{{$data['encounter_arr']['bhcpf_encounter_this_year']}}</div>
		...
		@foreach($data['bhcpf-categories'] as $category)
		...
		<div class="bg-white border my-2">
			...
			<div style="width: 100%; height: 40px;" class="  pad  d-flex ld-zoom-in" data-aos="fade-left">
				...
				<div class="d-flex flex-column just-center-c  w-50">
					...
					<span class="b-title">{{$category->category}}:</span>

					<span class="fa fa-{{$icons[$loop->index]}} ml-4 text-info" style="font-size:25px;"></span>

				</div>

				<div class=" mt-2 text-size-1">{{number_format($category->total)}} <code>{{round( ($category->total*100)/$total_bhcpf_enrollees, 1) }}%</code></div>

			</div>

			@if($category->category == 'Female Reproductive (15-45 years)')

			<div class=" w-100 text-right" style="color:#3ac779;font-weight:bold">

				<span class="b-title">% of Pregnant Women : {{number_format($data['bhcpf-pregnant-enrollee-count'])}} <code>{{round( ($data['bhcpf-pregnant-enrollee-count']*100)/$category->total, 1) }}%</code></span>
			...
			<div class=" w-100 text-right" style="color:#239656;font-weight:bold">
				...
				<span class="b-title">% of Women Not Pregnant : {{number_format($category->total - $data['bhcpf-pregnant-enrollee-count'])}} <code>{{round( (($category->total - $data['bhcpf-pregnant-enrollee-count'])*100)/$category->total, 1) }}%</code></span>
		...
		@foreach($data['bhcpf-disabilities'] as $group)

		@if($group->disability != 'None' && !empty($group->disability))
		...
		<div class="bg-white border my-2">
			...
			<div style="width: 100%; height: 40px;" class="  pad  d-flex ld-zoom-in" data-aos="fade-left">
				...
				<div class="d-flex flex-column just-center-c  w-50">
					...
					<span class="b-title">{{$group->disability}}:</span>

					<span class="fa fa-{{isset($icons2[$loop->index]) ? $icons2[$loop->index] : ''}} ml-4 text-info" style="font-size:25px;"></span>

				</div>

				<div class=" mt-2 text-size-1">{{number_format($group->total)}} </div>
		...
		<h4>
			...
			Overall % Disabled = {{ $disable_total}} - <code>{{ (100 - round( ($none_disable_total*100)/$total_bhcpf_enrollees, 1)) }}%</code> <br>

			Overall % None Disabled = {{ number_format($none_disable_total)}} - <code>{{round( ($none_disable_total*100)/$total_bhcpf_enrollees, 1) }}%</code>
		...
		<div class="bg-white border ">
			...
			<div style="width: 100%; height: 40px;" class="  d-flex pad ld-zoom-in" data-aos="fade-left">
				...
				<div class=" mt-2 text-size-1">{{ number_format($data['nicare-bhcpf-sex-count'][2]->sex == 'Male'  
		...
		<div class="bg-white border my-2">
			...
			<div style="width: 100%; height: 40px;" class="   d-flex pad  ld-zoom-in" data-aos="fade-left">
				...
				<div class=" mt-2 text-size-1">{{ number_format($data['nicare-bhcpf-sex-count'][2]->sex == 'Female'  
