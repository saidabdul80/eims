...
<div class="row m-0 text-center" id="dashboard_top_figures_wrap" style="width: 100%;">
        <div class="col-md-3 col-lg-3 pd-r">
                ...
                <h2 class="timer count-title count-number" data-to="157" data-speed="1500" id="nicare_enrollees">{{number_format($data['nicare-bhcpf-count'][0]->total)}}</h2>
	        ...
	        <div class="counter"  style="border-bottom:5px solid #db3b99">
                ...
                <h2 class="timer count-title count-number" data-to="157" data-speed="1500">{{number_format($data['providers-count'])}}</h2>
              ...
              <div class="col-md-2 col-lg-3 pd-3">
               <div class="counter"  style="border-bottom:5px solid #075c8a">
                ...
                <h2 class="timer count-title count-number" data-to="1700" data-speed="1500">&#8358;{{ number_format($months[intval(date('m'))]['nicare_cap'] )}}</h2>
                <p class="count-text ">Capitation  ({{date('M')}}, {{date('Y')}})</p>
                </div>
              </div>
              <div class="col-md-3 col-lg-3 pd-l ">
                <div class="counter"  style="border-bottom:5px solid #db3b99">
                <i class="fa fa-money fa-x text-danger"></i>
                <h2 class="timer count-title count-number" data-to="11900" data-speed="1500" id="next_month_cap">&#8358;{{number_format($data['nicare-bhcpf-count'][0]->total * 360)}}</h2>
