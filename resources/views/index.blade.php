    ...
    <form action="{{url('post-login')}}" method="POST" id="logForm">
			...
			<p class="text-center" style="color:skyblue;font-weight:bolder">NiCare  Portal</p>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<h2><input type="text"  name="nicare_code" id="nicare_code" value="{{ old('nicare_code')}}" class="form-control" placeholder="User ID" autocomplete="off" required /></h2>
				</div>
				<hr/>
				<hr/>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<h2 style="margin-top:10px"><input type="password"  name="password" id="password" value="{{ old('password')}}" class="form-control" placeholder="Password" autocomplete="off" required/></h2>
				</div>
				<hr/>
				<hr/>
					<div>
