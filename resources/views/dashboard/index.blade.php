            ...
            <div class="row">
                <div class="col-md-8">
					<div class="scheme-home-text-wrap">
						...
						<h2 style="color:#67b1e6"><strong> Referal Claim Management System System (<span>RCMS</span>)</strong></h2>
						<div>  </div>
						<hr/>
    ...
    <form action="{{url('post-login')}}" method="POST" id="logForm">
			...
			<p class="text-center" style="color:skyblue;font-weight:bolder">NiCare  Portal</p>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<input type="text"  name="nicare_code" id="nicare_code" value="{{ old('nicare_code')}}" class="form-control" placeholder="User ID" autocomplete="off" required />
				</div>
				<hr/>
				<hr/>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<input type="password"  name="password" id="password" value="{{ old('password')}}" class="form-control" placeholder="Password" autocomplete="off" required/>
				</div>
				<hr/>
				<hr/>
					<div>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-right">
					<button type="submit" name="login-button" id="submit" class="btn btn-light btn-radius btn-brd grd1 ">LOGIN</button>
				</div>
			</fieldset>
            @if ($errors->any())
                <hr/>
