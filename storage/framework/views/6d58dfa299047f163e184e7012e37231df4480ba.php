...
QRcode::png($enrollee->enrolment_number, 'qrcode_image.png'); 
 ?>
	<?php if($enrollee->mode_of_enrolment == 'Premium'): ?>		
            <div class="page <?php echo e(($loop->index > 0 ? 'page_break' : '')); ?>">
				<p><img src="https://ngscha.ni.gov.ng/apps/img/heading.png" style="width:320.52px;height:50px"/></p>
					...
					<tr>
							...
							<div style="padding: 0px 5px">
								<p class="data"> NICARE NO.: <?php echo e($enrollee->enrolment_number); ?></p>
								<p class="data"> NAME : <?php echo e($enrollee->surname.' '.$enrollee->first_name.' '.$enrollee->other_name); ?></p>
								<p class="data"> SEX: <?php echo e($enrollee->sex); ?></p>
								<p class="data"> DOB: <?php echo e($enrollee->date_of_birth); ?></p>
                                <p class="data"> OCCUPATION: <?php echo e($enrollee->occupation); ?></p>
								<p class="data">  PROVIDER: <?php echo e(provider_name($providers,$enrollee->provider_id)); ?></p>
							</div>
						</td>
						<td style="width:100px;"><br>
								<img src="https://ngscha.ni.gov.ng/apps/img_data/enrollees/<?php echo e($enrollee->id); ?>.jpg" width="90px" height="100px" style="border:3px solid #fff;margin-right:2px"/><br>
								Exp. Date: 
						</td>
					</tr>
				</table>
    ...
    <table width="100%" style="background:none;">
                    <tr>
                        ...
                        <br/>
                                ...
                                <p style="margin-bottom: 5px"><img src="https://ngscha.ni.gov.ng/apps/img_data/enrollees/<?php echo e($enrollee->id); ?>.jpg" width="100px" height="100px" style="border:3px solid #3e9c62;margin-left:20px"/></p>
                                
                                <div style="text-align:center;line-height:10px"> 
                                    <?php echo e($enrollee->enrolment_number); ?><br/>
                        ...
                        <td style="padding:0;margin:0" width="80%">
                                <div style="padding-top: 10px;padding-left: 10px">
                                        <br/>
                                <p class="data-huwe"> <span>LUNIQUE ID.:</span><br/> <?php echo e($enrollee->BHCPF_number); ?>

                                <br/> <span>NAME : </span><br/> <?php echo e($enrollee->surname.' '.$enrollee->first_name.' '.$enrollee->other_name); ?>

                                <br/> <span>SEX: :</span><br/> <?php echo e($enrollee->sex); ?>

                                <br/> <span>Date of Birth	: :</span><br/> <?php echo e($enrollee->date_of_birth); ?>
...
</html><?php /**PATH /home3/ngschdqn/eims.ngscha.ni.gov.ng/resources/views/enrolment/print_idcard_by_provider_html.blade.php ENDPATH**/ ?>