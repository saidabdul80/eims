		...
		<div id="collapse1" class="panel-collapse collapse" role="tabpane1" aria-labelledby="heading1">
		  ...
		  <div class="panel-body">
				...
				<ul>
						...
						<li class=""> <a href="<?php echo e(route('enrolment.bhcpf-enrollees')); ?>" ><i class="fa fa-chevron-right"></i> BHCPF Enrollees  </a></li>
            ...
            <div id="collapsepremium" class="panel-collapse collapse" role="tabpanepremium" aria-labelledby="headingpremium">
				  ...
				  <div class="panel-body">
							...
							<ul>
									...
									<li class=""> <a href="<?php echo e(route('premium.reports')); ?>" ><i class="fa fa-chevron-right"></i> Expiration Reports  </a></li>
...
<div class="panel-body">							
		...
		<ul>
				...
				<li class=""> <a href="<?php echo e(route('mgt_institution')); ?>" ><i class="fa fa-chevron-right"></i>Institution & Student Management </a></li>
				
				<li class=""> <a href="<?php echo e(route('assign_tpa')); ?>" ><i class="fa fa-chevron-right"></i>Assign Tpa </a></li>
				<li class=""> <a href="<?php echo e(route('pToI')); ?>" ><i class="fa fa-chevron-right"></i> Provider to Institution</a></li>
				<li class=""> <a href="<?php echo e(route('session')); ?>" ><i class="fa fa-chevron-right"></i> Manage Session</a></li>
...
<?php /**PATH C:\Users\User\Desktop\Desktop\eims.ngscha.ni.gov.ng\resources\views/layouts/sidemenu.blade.php ENDPATH**/ ?>