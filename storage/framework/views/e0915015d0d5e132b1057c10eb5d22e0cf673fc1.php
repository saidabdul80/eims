...
<div >
    <br>
    <br>
    <div class="jumbotron px-3 py-2 text-dark d-inline-block">::Assign Tpa to Institution</div>
    <div class="w-100" style="height: 68vh;">
   ...
   var  fetchData = function(callback,url,target,assign_url, deassign_url, type, start = 0, length = 7, search = "" ){ 
    ...
    $(".serachX").on('keyup', function (e) {
        ...
        if (e.key === 'Enter' || e.keyCode === 13) {            
            fetchData(executeX,'tpas',"dataTablex","assign_tpa_to_institution","deassign_tpa_from_institution",1, 0, 7, `${text}`    )
        }
    });


fetchData(executeX,'tpas',"dataTablex", "assign_tpa_to_institution","deassign_tpa_from_institution",1);
...
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\Desktop\eims.ngscha.ni.gov.ng\resources\views/institution/assign_tpa.blade.php ENDPATH**/ ?>