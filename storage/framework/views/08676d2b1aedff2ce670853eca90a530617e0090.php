...
<tr >
	...
	<h3 class="panel-heading">Biometric Verification </h3>
	  ...
	  <P class="text-right">
	    ...
	    <?php if($enrollee->enrolment_approval_status == 2): ?>
	        <button class="btn btn-success"  id="approve_btn" onclick="approve_reject_enrolment(<?php echo e($enrollee->id); ?>,1)" >Approve Enrolment</button>
	    <?php else: ?>
	        <button class="btn btn-success"  id="approve_btn" onclick="approve_reject_enrolment(<?php echo e($enrollee->id); ?>,1)" <?php echo e(($enrollee->enrolment_approval_status != '0' ? 'disabled' :'')); ?>>Approve Enrolment</button>
			<button type="submit" class="btn btn-danger" id="reject_btn" onclick="approve_reject_enrolment(<?php echo e($enrollee->id); ?>,2)" <?php echo e(($enrollee->enrolment_approval_status != '0' ? 'disabled' :'')); ?>>Approve Enrolment With Issue</button>
	    <?php endif; ?>
...
<?php /**PATH /home3/ngschdqn/eims.ngscha.ni.gov.ng/resources/views/enrolment/enrollee_info_with_biometric.blade.php ENDPATH**/ ?>