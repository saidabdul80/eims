...
<p class="text-right"> <a href="<?php echo e(route('enrolment.enrolment-approval')); ?>" class="btn btn-sm btn-primary"> Back to Approval Page </a></p>
  <br/>
  <br/>
<div class="container">
        ...
        <tr>
            ...
            <?php $__currentLoopData = $enrollees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="row_<?php echo e($enrollee->id); ?>">
                    ...
                    <td class="text-center" > <?php echo e($enrollee->approval_comment); ?></td>
                    ...
                    <td class="text-center"><?php echo e($enrollee->village); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/ngschdqn/eims.ngscha.ni.gov.ng/resources/views/enrolment/recapture_list.blade.php ENDPATH**/ ?>